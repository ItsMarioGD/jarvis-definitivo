...
def test_respuestas_completas():
    ...
    movil = open(os.path.join(raiz, "web_interface", "mobile.html"), encoding="utf-8").read()
    _check(".slice(0, 400)" not in movil and "trocearVoz" in movil,
           "el móvil dice la respuesta entera, por trozos")
    web = open(os.path.join(raiz, "web_interface", "index.html"), encoding="utf-8").read()
    _check("t.slice(0,1800)" not in web and "trocearVoz" in web,
           "la web dice la respuesta entera, por trozos")
